...
| `@web3-react/mewconnect-connector`         | [![npm version](https://img.shields.io/npm/v/@web3-react/mewconnect-connector/latest.svg)](https://www.npmjs.com/package/@web3-react/mewconnect-connector/v/latest)                 | [![minzip](https://img.shields.io/bundlephobia/minzip/@web3-react/mewconnect-connector/latest.svg)](https://bundlephobia.com/result?p=@web3-react/mewconnect-connector@latest)                 | [MEWconnect](https://mewconnect.myetherwallet.com/) Connector|
| 🐉 **Low-Level**                      |
