...
| [`@web3-react/magic-connect`](packages/magic-connect) | [![npm](https://img.shields.io/npm/v/web3-react-magic-connect)](https://www.npmjs.com/package/web3-react-magic-connect) | [![minzip](https://img.shields.io/bundlephobia/minzip/web3-react-magic-connect)](https://bundlephobia.com/package/web3-react-magic-connect) | [Magic Connect](https://magic.link/docs/connect/overview)        |
