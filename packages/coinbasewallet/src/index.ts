import type { CoinbaseWalletProvider, CoinbaseWalletSDK as CoinbaseWalletInstance } from '@coinbase/wallet-sdk'
...
type CoinbaseWalletSDKOptions = ConstructorParameters<typeof CoinbaseWalletInstance>[0] & { url: string }

export class CoinbaseWalletSDK extends Connector {
   ...
   */
  public coinbaseWalletSDK: CoinbaseWalletInstance | undefined

  /**
   * @param options - Options to pass to `coinbaseWalletSDK`
  ...
  private async isomorphicInitialize(): Promise<void> {
    ...
    await (this.eagerConnection = import('@coinbase/wallet-sdk').then((m) => {
      ...
      this.coinbaseWalletSDK = new m.default(options)
      this.provider = this.coinbaseWalletSDK.makeWeb3Provider(url)
  ...
  public deactivate(): void {
    this.coinbaseWalletSDK?.disconnect()
  }
}
